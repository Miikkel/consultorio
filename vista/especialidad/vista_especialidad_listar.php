        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-lg-12">
                    ...
                    <input type="text" class="form-control" id="txt_especialidad" placeholder="Ingrese especialidad medico"><br>
                </div>
                <div class="col-lg-12">
...
<div class="modal fade" id="modal_editar" role="dialog">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header" style="text-align:center;">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title"><b>Actualizar especialidad</b></h4>    
            </div>
            <div class="modal-body">
                <div class="col-lg-12">
                    <input type="text" id="txt_idespecialidad" hidden>
                    <label for="">Nombre</label>
                    <input type="text" id="txt_especialidad_actual_editar" placeholder="Ingrese especialidad medico" hidden><br>
                    <input type="text" class="form-control" id="txt_especialidad_nuevo_editar" placeholder="Ingrese especialidad medico"><br>
                </div>
                <div class="col-lg-12">
                    <label for="">Estatus</label>
            ...
            <div class="modal-footer">
                <button class="btn btn-primary" onclick="Editar_Especialidad()"><i class="fa fa-check"><b>&nbsp;Actualizar</b></i></button>
                <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-close"><b>&nbsp;Cerrar</b></i></button>
            </div>
        </div>
    </div>
