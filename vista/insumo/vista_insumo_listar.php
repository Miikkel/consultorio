...
<div class="col-md-12">
    <div class="box box-warning box-solid">
        <div class="box-header with-border">
              <h3 class="box-title">MANTENIMIENTO INSUMO</h3>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header" style="text-align:center;">
                ...
                <h4 class="modal-title"><b>Registro Insumo</b></h4>    
            </div>
            <div class="modal-body">
                ...
                <div class="col-lg-12">
                    ...
                    <input type="text" class="form-control" id="txt_stock" placeholder="Ingrese stock de insumo" maxlength="5" onkeypress="return soloNumeros(event)"><br>
                </div>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-lg-12">
                    <label for="">Stock</label>
                    <input type="text" class="form-control" id="txt_stock_editar" placeholder="Ingrese stock de insumo" maxlength="5" onkeypress="return soloNumeros(event)"><br>
                </div>
